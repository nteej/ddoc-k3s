...
class TagRepository implements TagRepositoryInterface
{
    ...
    public function findAllUsingFilters(array $filters = []): Collection
    {
        ...
        foreach ($query as $contextTags) {
            $options = $contextTags->tagOptions
                ? json_decode($contextTags->tagOptions, true)
                : null;
    ...
    public function findFirstUsingFilters(array $filters = []): ?Tag
    {
        ...
        return Tag::restore(
            ...
            options: $tag->options ? json_decode($tag->options, true) : null,
        );
    }
     ...
     public function insert(Tag $tag): string
    {
        DB::table("tags")
            ->insert([
                ...
                'options' => $tag->options !== null ? json_encode($tag->options) : null,
            ]);
